...
var _excluded = ["Default", "backgroundColor", "size", "label", "ghost"];
...
var Button = function (_ref) {
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__["jsx"])("button", Object.assign({
    type: "button",
    className: ['storybook-button', `storybook-button--${size}`, `storybook-button--${ghost}`, mode].join(' '),
...
Button.propTypes = {
   ...
   */
  type: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOf(['default', 'ghost'])
};
Button.defaultProps = {
...
//# sourceMappingURL=main.8f63c1665a7de6f5d02d.hot-update.js.map