...
var _excluded = ["Default", "backgroundColor", "size", "label", "type"];
...
var Button = function (_ref) {
  ...
  return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__["jsx"])("button", Object.assign({
    type: "button",
    className: ['storybook-button', `storybook-button--${size}`, `storybook-button--${type}`, mode].join(' '),
...
Button.propTypes = {
  ...
  type: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOf(['default', 'ghost-default', 'ghost-secondary', 'ghost-pressed', 'ghost-focused', 'ghost-disabled'])
};
Button.defaultProps = {
...
//# sourceMappingURL=main.cd2ca0761de7a7aa123f.hot-update.js.map